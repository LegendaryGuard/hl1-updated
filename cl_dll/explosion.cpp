...
bool CHudExplosion::Draw(float flTime)
{
...
void CHudExplosion::AddExplosion(Vector org, int radius, char r, char g, char b, char a)
{
	//draw light flash
